    ...
    <section id="pricing" className="py-24 bg-gradient-to-b from-white to-slate-50 relative">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-end max-w-6xl mx-auto">
          ...
          {/* Professional */}
          <div className="bg-blue-50/50 border-2 border-secondary rounded-3xl p-8 relative shadow-xl transform scale-105 z-10">
            ...
            <h3 className="text-xl font-semibold text-secondary mb-2">Professional</h3>
            <div className="flex items-baseline gap-1 mb-2">
          ...
          {/* Business */}
          <div className="bg-white border rounded-3xl p-8 hover:shadow-lg transition-shadow">
            <h3 className="text-xl font-semibold text-gray-500 mb-2">Business</h3>
            <div className="flex items-baseline gap-1 mb-2">
